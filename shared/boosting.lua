...
Config.Boosting.Notifications = "notify" -- Use this for qb // renewed phone intergration, use "notify" for normal QBCore Notifications
...
Config.Boosting.HackDelayMin = 3 -- Seconds
Config.Boosting.HackDelayMax = 20 -- Seconds
...
Config.Boosting.PedSettings = {
    ["D"] = {weapons = {"weapon_bat", "weapon_knuckle"}},
...
Config.Boosting.ReturnLocation = {
    ...
    { coords = vector3(-376.1713, -2282.364, 7.6081871), isBusy = false },
    { coords = vector3(-1156.738, -2006.131, 13.180253), isBusy = false },
    { coords = vector3(-24.09204, -343.8954, 43.032524), isBusy = false },
    { coords = vector3(-2785.557, 1431.7637, 100.9284), isBusy = false },
    { coords = vector3(-83.49147, 1879.9287, 197.27673), isBusy = false },
    { coords = vector3(865.26562, 2172.0244, 52.286354), isBusy = false },
    { coords = vector3(2716.2763, 4131.2666, 43.892929), isBusy = false },
    { coords = vector3(1371.5521, 6553.8759, 14.75716), isBusy = false },
    { coords = vector3(78.696769, 6640.6894, 31.962158), isBusy = false },
}
